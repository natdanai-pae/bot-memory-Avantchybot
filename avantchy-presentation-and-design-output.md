...
- For individual performance/evaluation infographics, remember to include a radar/spider chart when it fits the data. The user specifically reminded on 2026-06-15 not to forget the spider chart in the sample-style personnel evaluation infographic.
